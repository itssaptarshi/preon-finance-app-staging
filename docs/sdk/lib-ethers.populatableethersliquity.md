...
|  [borrowSTAR(amount, ICRWithFees, maxBorrowingRate, overrides)](./lib-ethers.populatableethersliquity.borrowstar.md) |  | Adjust existing Trove by borrowing more STAR. |
...
|  [claimRewardsSwap(amount, overrides)](./lib-ethers.populatableethersliquity.claimrewardsswap.md) |  | Withdraw STAR from Stability Deposit. |
...
|  [createLock(amount, unlockTime, overrides)](./lib-ethers.populatableethersliquity.createlock.md) |  |  |
...
|  [depositSTARInStabilityPool(amount, overrides)](./lib-ethers.populatableethersliquity.depositstarinstabilitypool.md) |  | Make a new Stability Deposit, or top up existing one. |
...
|  [getVePreonStakeReward(overrides)](./lib-ethers.populatableethersliquity.getvepreonstakereward.md) |  |  |
|  [increaseVestAmount(amount, tokenId, overrides)](./lib-ethers.populatableethersliquity.increasevestamount.md) |  |  |
|  [increaseVestDuration(tokenId, unlockTime, overrides)](./lib-ethers.populatableethersliquity.increasevestduration.md) |  |  |
...
|  [merge(from, to, overrides)](./lib-ethers.populatableethersliquity.merge.md) |  |  |
...
|  [openTrove(params, ICRWithFees, maxBorrowingRateOrOptionalParams, overrides)](./lib-ethers.populatableethersliquity.opentrove.md) |  | Open a new Trove by depositing collateral and borrowing STAR. |
...
|  [rageQuit(tokenId, overrides)](./lib-ethers.populatableethersliquity.ragequit.md) |  |  |
|  [redeemSTAR(amount, maxRedemptionRate, overrides)](./lib-ethers.populatableethersliquity.redeemstar.md) |  | Redeem STAR to native currency (e.g. Ether) at face value. |
|  [repaySTAR(amount, ICRWithFees, overrides)](./lib-ethers.populatableethersliquity.repaystar.md) |  | Adjust existing Trove by repaying some of its debt. |
|  [sendPREON(toAddress, amount, overrides)](./lib-ethers.populatableethersliquity.sendpreon.md) |  |  |
|  [sendSTAR(toAddress, amount, overrides)](./lib-ethers.populatableethersliquity.sendstar.md) |  | Send STAR tokens to an address. |
|  [stakeLPTokens(amount, tokenId, overrides)](./lib-ethers.populatableethersliquity.stakelptokens.md) |  |  |
...
|  [unlock(tokenId, overrides)](./lib-ethers.populatableethersliquity.unlock.md) |  |  |
|  [updateVEPREON(params, overrides)](./lib-ethers.populatableethersliquity.updatevepreon.md) |  |  |
...
|  [withdrawSTARFromStabilityPool(amount, overrides)](./lib-ethers.populatableethersliquity.withdrawstarfromstabilitypool.md) |  | Withdraw STAR from Stability Deposit. |
