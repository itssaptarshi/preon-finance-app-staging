...
|  maxBorrowingRate | [Decimalish](./lib-base.decimalish.md) | Maximum acceptable [borrowing rate](./lib-base.fees.borrowingrate.md) if <code>params</code> includes <code>borrowSTAR</code>. |
...
The transaction will fail if the Trove's debt would fall below [STAR\_MINIMUM\_DEBT](./lib-base.star_minimum_debt.md)<!-- -->.
