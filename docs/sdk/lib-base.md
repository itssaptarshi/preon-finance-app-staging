...
|  [vePREONStake](./lib-base.vepreonstake.md) | Represents the change between two states of a vePREON Stake. |
...
|  [RedemptionDetails](./lib-base.redemptiondetails.md) | Details of a [redeemSTAR()](./lib-base.transactableliquity.redeemstar.md) transaction. |
...
|  [StabilityDepositChangeDetails](./lib-base.stabilitydepositchangedetails.md) | Details of a [depositSTARInStabilityPool()](./lib-base.transactableliquity.depositstarinstabilitypool.md) or [withdrawSTARFromStabilityPool()](./lib-base.transactableliquity.withdrawstarfromstabilitypool.md) transaction. |
...
|  --- | --- |
|  [\_normalizeTroveAddCollLeverUp](./lib-base._normalizetroveaddcollleverup.md) |  |
|  [\_normalizeTroveLeverUpCreation](./lib-base._normalizetroveleverupcreation.md) |  |
|  [\_normalizeTroveWithdrawCollUnleverUp](./lib-base._normalizetrovewithdrawcollunleverup.md) |  |
...
|  [STAR\_LIQUIDATION\_RESERVE](./lib-base.star_liquidation_reserve.md) | Amount of STAR that's reserved for compensating the liquidator of a Trove. |
|  [STAR\_MINIMUM\_DEBT](./lib-base.star_minimum_debt.md) | A Trove must always have at least this much debt. |
|  [STAR\_MINIMUM\_NET\_DEBT](./lib-base.star_minimum_net_debt.md) | A Trove must always have at least this much debt on top of the [liquidation reserve](./lib-base.star_liquidation_reserve.md)<!-- -->. |
