...
|  [newSTARDeposit](./lib-base.stabilitypoolgainswithdrawaldetails.newstardeposit.md) | [Decimal](./lib-base.decimal.md) | Amount of STAR in the deposit directly after this transaction. |
|  [starLoss](./lib-base.stabilitypoolgainswithdrawaldetails.starloss.md) | [Decimal](./lib-base.decimal.md) | Amount of STAR burned from the deposit by liquidations since the last modification. |
