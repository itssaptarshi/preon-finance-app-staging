...
|  [approveUniTokens(allowance)](./lib-base.transactableliquity.approveunitokens.md) | Allow the liquidity mining contract to use Uniswap ETH/STAR LP tokens for [staking](./lib-base.transactableliquity.stakeunitokens.md)<!-- -->. |
|  [borrowSTAR(amount, maxBorrowingRate)](./lib-base.transactableliquity.borrowstar.md) | Adjust existing Trove by borrowing more STAR. |
...
|  [depositSTARInStabilityPool(amount, frontendTag)](./lib-base.transactableliquity.depositstarinstabilitypool.md) | Make a new Stability Deposit, or top up existing one. |
...
|  [openTrove(params, maxBorrowingRate)](./lib-base.transactableliquity.opentrove.md) | Open a new Trove by depositing collateral and borrowing STAR. |
|  [redeemSTAR(amount, maxRedemptionRate)](./lib-base.transactableliquity.redeemstar.md) | Redeem STAR to native currency (e.g. Ether) at face value. |
...
|  [repaySTAR(amount)](./lib-base.transactableliquity.repaystar.md) | Adjust existing Trove by repaying some of its debt. |
|  [sendLQTY(toAddress, amount)](./lib-base.transactableliquity.sendlqty.md) | Send LQTY tokens to an address. |
|  [sendSTAR(toAddress, amount)](./lib-base.transactableliquity.sendstar.md) | Send STAR tokens to an address. |
...
|  [stakeUniTokens(amount)](./lib-base.transactableliquity.stakeunitokens.md) | Stake Uniswap ETH/STAR LP tokens to participate in liquidity mining and earn LQTY. |
...
|  [unstakeUniTokens(amount)](./lib-base.transactableliquity.unstakeunitokens.md) | Withdraw Uniswap ETH/STAR LP tokens from liquidity mining. |
...
|  [withdrawGainsFromStabilityPool()](./lib-base.transactableliquity.withdrawgainsfromstabilitypool.md) | Withdraw [collateral gain](./lib-base.stabilitydeposit.collateralgain.md) and  from Stability Deposit. |
|  [withdrawGainsFromStaking()](./lib-base.transactableliquity.withdrawgainsfromstaking.md) | Withdraw  and  from LQTY stake. |
...
|  [withdrawSTARFromStabilityPool(amount)](./lib-base.transactableliquity.withdrawstarfromstabilitypool.md) | Withdraw STAR from Stability Deposit. |
