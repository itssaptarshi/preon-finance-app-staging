...
|  [approveUniTokens(allowance)](./lib-base.sendableliquity.approveunitokens.md) | Allow the liquidity mining contract to use Uniswap ETH/STAR LP tokens for [staking](./lib-base.transactableliquity.stakeunitokens.md)<!-- -->. |
|  [borrowSTAR(amount, maxBorrowingRate)](./lib-base.sendableliquity.borrowstar.md) | Adjust existing Trove by borrowing more STAR. |
...
|  [depositSTARInStabilityPool(amount, frontendTag)](./lib-base.sendableliquity.depositstarinstabilitypool.md) | Make a new Stability Deposit, or top up existing one. |
...
|  [openTrove(params, maxBorrowingRate)](./lib-base.sendableliquity.opentrove.md) | Open a new Trove by depositing collateral and borrowing STAR. |
|  [redeemSTAR(amount, maxRedemptionRate)](./lib-base.sendableliquity.redeemstar.md) | Redeem STAR to native currency (e.g. Ether) at face value. |
...
|  [repaySTAR(amount)](./lib-base.sendableliquity.repaystar.md) | Adjust existing Trove by repaying some of its debt. |
|  [sendLQTY(toAddress, amount)](./lib-base.sendableliquity.sendlqty.md) | Send LQTY tokens to an address. |
|  [sendSTAR(toAddress, amount)](./lib-base.sendableliquity.sendstar.md) | Send STAR tokens to an address. |
...
|  [stakeUniTokens(amount)](./lib-base.sendableliquity.stakeunitokens.md) | Stake Uniswap ETH/STAR LP tokens to participate in liquidity mining and earn LQTY. |
...
|  [unstakeUniTokens(amount)](./lib-base.sendableliquity.unstakeunitokens.md) | Withdraw Uniswap ETH/STAR LP tokens from liquidity mining. |
...
|  [withdrawSTARFromStabilityPool(amount)](./lib-base.sendableliquity.withdrawstarfromstabilitypool.md) | Withdraw STAR from Stability Deposit. |
