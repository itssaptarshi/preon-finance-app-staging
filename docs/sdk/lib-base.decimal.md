...
Used by Liquity libraries to precisely represent native currency (e.g. Ether), STAR and LQTY amounts, as well as derived metrics like collateral ratios.
...
|  --- | --- | --- |
|  [\_fromStringWithPrecision(representation, precision)](./lib-base.decimal._fromstringwithprecision.md) | <code>static</code> |  |
...
|  [fromWithPrecision(decimalish, precision)](./lib-base.decimal.fromwithprecision.md) | <code>static</code> |  |
...
|  [toNumber()](./lib-base.decimal.tonumber.md) |  |  |
|  [toString(precision)](./lib-base.decimal.tostring.md) |  |  |
|  [toStringWithDecimals(decimals)](./lib-base.decimal.tostringwithdecimals.md) |  |  |
