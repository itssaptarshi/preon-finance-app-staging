...
[Home](./index.md) &gt; [@liquity/lib-base](./lib-base.md) &gt; [PopulatableLiquity](./lib-base.populatableliquity.md) &gt; [depositSTARInStabilityPool](./lib-base.populatableliquity.depositstarinstabilitypool.md)

## PopulatableLiquity.depositSTARInStabilityPool() method
...
|  --- | --- | --- |
|  amount | [Decimalish](./lib-base.decimalish.md) | Amount of STAR to add to new or existing deposit. |
