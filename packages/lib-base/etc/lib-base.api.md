...
export class _CachedReadableLiquity<T extends unknown[]> implements _ReadableLiquityWithExtraParams<T> {
    ...
    // (undocumented)
    getAllowanceOf(owner: any, token: any, spender: any, amount: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getBalanceERC20(address: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getBalances(addresses: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getBoostedFarm(address: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getCollateralSurplusBalancee(...extraParams: any): Promise<any>;
    // (undocumented)
    getCollPrice(address: string, ...extraParams: any): Promise<any>;
    // (undocumented)
    getCollPrices(addresses: Array<string>, vaultTokens: any, underlyingDecimals: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getCurrentAICR(borrower: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getDecayedBoost(address: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getDecimals(addresses: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getDepositFee(VCInput: any, VCOutput: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getEstimatedFarmRewards(amount: any, time: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getEstimatedPREONPoolRewards(amount: any, time: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getEstimatedVePreonRewards(amount: any, time: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getFarm(address: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getFees(...extraParams: T): Promise<Fees>;
    // (undocumented)
    getGlobalBoostFactor(...extraParams: any): Promise<any>;
    // (undocumented)
    getICR(userAddress: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getLP(address: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getLPBalances(addresses: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getNumberOfTroves(...extraParams: T): Promise<number>;
    // (undocumented)
    getPoolRewardRate(...extraParams: any): Promise<any>;
    // (undocumented)
    getPREONBalance(address: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getPREONPrice(...extraParams: any): Promise<any>;
    // (undocumented)
    getPrices(addresses: Array<string>, ...extraParams: any): Promise<any>;
    // (undocumented)
    getReceiptPerUnderlying(address: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getReceiptPerUnderlyingRatios(addresses: any, vaultTokens: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getRecoveryRatios(addresses: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getRedemptionBonus(address: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getRedemptionFeeRate(...extraParams: any): Promise<any>;
    // (undocumented)
    getRemainingStabilityPoolPREONReward(...extraParams: any): Promise<any>;
    // (undocumented)
    getSafetyRatios(addresses: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getSortedTroveHead(...extraParams: any): Promise<any>;
    // (undocumented)
    getSortedTroveNext(id: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getSortedTrovePrev(id: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getSortedTroveSize(...extraParams: any): Promise<any>;
    // (undocumented)
    getSortedTroveTail(...extraParams: any): Promise<any>;
    // (undocumented)
    getStabilityDeposit(address?: string, ...extraParams: T): Promise<StabilityDeposit>;
    // (undocumented)
    getStarAllowance(from: any, to: any, amount: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getSTARBalance(address?: string, ...extraParams: T): Promise<Decimal>;
    // (undocumented)
    getSTARInStabilityPool(...extraParams: T): Promise<Decimal>;
    // (undocumented)
    getSTARPrice(...extraParams: any): Promise<any>;
    // (undocumented)
    ...
    // (undocumented)
    getTroveDebt(borrower: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    ...
    // (undocumented)
    getUnderlyingDecimal(address: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getUnderlyingDecimals(vaultTokens: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getUnderlyingPerReceipt(address: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getUnderlyingPerReceiptRatios(addresses: any, vaultTokens: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getUnderlyingToken(address: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getUnderlyingTokens(vaultTokens: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getVaultTokens(whitelistedCollaterals: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getVcValue(userAddress: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getVEPREONStake(address: any, ...extraParams: any): Promise<any>;
    // (undocumented)
    getWhitelistedCollaterals(...extraParams: any): Promise<any>;
    // (undocumented)
    hasClaimableCollateral(address: any, ...extraParams: any): Promise<any>;
    }
...
// @internal (undocumented)
export type _DebtChange<T> = (_STARBorrowing<T> & _NoSTARRepayment) | (_STARRepayment<T> & _NoSTARBorrowing);
...
// @public (undocumented)
export const _normalizeTroveWithdrawCollUnleverUp: (params: any) => {
...
// @internal (undocumented)
export type _NoSTARBorrowing = Partial<_STARBorrowing<undefined>>;

// @internal (undocumented)
export type _NoSTARRepayment = Partial<_STARRepayment<undefined>>;
...
export interface ObservableLiquity {
    ...
    // (undocumented)
    watchSTARInStabilityPool(onSTARInStabilityPoolChanged: (starInStabilityPool: Decimal) => void): () => void;
    // (undocumented)
...
export interface PopulatableLiquity<R = unknown, S = unknown, P = unknown> extends _PopulatableFrom<SendableLiquity<R, S>, P> {
    ...
    borrowSTAR(amount: Decimalish, maxBorrowingRate?: Decimalish): Promise<PopulatedLiquityTransaction<P, SentLiquityTransaction<S, LiquityReceipt<R, TroveAdjustmentDetails>>>>;
    ...
    depositSTARInStabilityPool(amount: Decimalish, frontendTag?: string): Promise<PopulatedLiquityTransaction<P, SentLiquityTransaction<S, LiquityReceipt<R, StabilityDepositChangeDetails>>>>;
    ...
    redeemSTAR(amount: Decimalish, maxRedemptionRate?: Decimalish): Promise<PopulatedRedemption<P, S, R>>;
    ...
    repaySTAR(amount: Decimalish): Promise<PopulatedLiquityTransaction<P, SentLiquityTransaction<S, LiquityReceipt<R, TroveAdjustmentDetails>>>>;
    ...
    withdrawSTARFromStabilityPool(amount: Decimalish): Promise<PopulatedLiquityTransaction<P, SentLiquityTransaction<S, LiquityReceipt<R, StabilityDepositChangeDetails>>>>;
}
...
export interface SendableLiquity<R = unknown, S = unknown> extends _SendableFrom<TransactableLiquity, R, S> {
    ...
    borrowSTAR(amount: Decimalish, maxBorrowingRate?: Decimalish): Promise<SentLiquityTransaction<S, LiquityReceipt<R, TroveAdjustmentDetails>>>;
    claimCollateralSurplus(): Promise<SentLiquityTransaction<S, LiquityReceipt<R, void>>>;
    closeTrove(overrides: any): Promise<SentLiquityTransaction<S, LiquityReceipt<R, TroveClosureDetails>>>;
    depositCollateral(amount: Decimalish): Promise<SentLiquityTransaction<S, LiquityReceipt<R, TroveAdjustmentDetails>>>;
    depositSTARInStabilityPool(amount: Decimalish, frontendTag?: string): Promise<SentLiquityTransaction<S, LiquityReceipt<R, StabilityDepositChangeDetails>>>;
    ...
    redeemSTAR(amount: Decimalish, maxRedemptionRate?: Decimalish): Promise<SentLiquityTransaction<S, LiquityReceipt<R, RedemptionDetails>>>;
...
export class StabilityDeposit {
    // @internal
    constructor(initialSTAR: Decimal, currentSTAR: Decimal, collateralGain: Decimal, preonReward: Decimal);
...
// @public
export const STAR_LIQUIDATION_RESERVE: Decimal;

// @public
export const STAR_MINIMUM_DEBT: Decimal;

// @public
export const STAR_MINIMUM_NET_DEBT: Decimal;

// @internal (undocumented)
export type _STARBorrowing<T> = {
    borrowSTAR: T;
};

// @internal (undocumented)
export type _STARRepayment<T> = {
    repaySTAR: T;
};
...
export interface TransactableLiquity {
    ...
    depositSTARInStabilityPool(amount: Decimalish, frontendTag?: string): Promise<StabilityDepositChangeDetails>;
...
export class Trove {
    // @internal
    constructor(collaterals?: {}, decimals?: Decimal, debt?: any);
    // (undocumented)
    add(that: any): Trove;
    // (undocumented)
...
// Warning: (ae-incompatible-release-tags) The symbol "TroveClosureParams" is marked as @public, but its signature references "_STARRepayment" which is marked as @internal
// Warning: (ae-incompatible-release-tags) The symbol "TroveClosureParams" is marked as @public, but its signature references "_NoSTARBorrowing" which is marked as @internal
//
// @public
export type TroveClosureParams<T> = _CollateralWithdrawal<T> & _NoCollateralDeposit & Partial<_STARRepayment<T>> & _NoSTARBorrowing;
...
// Warning: (ae-incompatible-release-tags) The symbol "TroveCreationParams" is marked as @public, but its signature references "_STARBorrowing" which is marked as @internal
// Warning: (ae-incompatible-release-tags) The symbol "TroveCreationParams" is marked as @public, but its signature references "_NoSTARRepayment" which is marked as @internal
//
// @public
export type TroveCreationParams<T = unknown> = _CollateralDeposit<T> & _NoCollateralWithdrawal & _STARBorrowing<T> & _NoSTARRepayment;
...
export class TroveWithPendingRedistribution extends UserTrove {
    // @internal
    constructor(ownerAddress: string, status: UserTroveStatus, collaterals?: any, decimals?: any, debt?: any, stake?: any, snapshotOfTotalRedistributed?: any);
    // (undocumented)
...
export class UserTrove extends Trove {
    // @internal
    constructor(ownerAddress: string, status: UserTroveStatus, collaterals?: any, decimals?: any, debt?: Decimal);
    // (undocumented)
...
export class vePREONStake {
    // @internal
    constructor(preonStake?: Decimal, vePREONGain?: Decimal, vePREONTotal?: Decimal, totalUserPreon?: Decimal, totalPreon?: Decimal, preonEarned?: Decimal, rewardRate?: Decimal, accumulationRate?: Decimal, boostAmount?: Decimal, boostFactor?: Decimal, boostRewardRate?: Decimal, boostBasePartition?: Decimal, preonStakeOnFarm?: Decimal, boostSumOfFactors?: Decimal, vePreonOnFarm?: Decimal);
    // (undocumented)
