...
export interface LiquityStoreBaseState {
  ...
  /** Remaining PREON that will be collectively rewarded to liquidity miners. */
  // remainingLiquidityMiningPREONReward: Decimal;
...
export interface LiquityStoreDerivedState {
   ...
   *
   * @remarks
   * Note that the actual rate paid by a redemption transaction will depend on the amount of STAR
   * being redeemed.
   *
...
export abstract class LiquityStore<T = unknown> {
  ...
  private _reduce(
    ...
    return {
      ...
      starBalance: this._updateIfChanged(
        eq,
        "starBalance",
        baseState.starBalance,
        baseStateUpdate.starBalance
      ),
      preonBalance: this._updateIfChanged(
        eq,
        "preonBalance",
        baseState.preonBalance,
        baseStateUpdate.preonBalance
      ),
      ...
      starInStabilityPool: this._updateIfChanged(
        eq,
        "starInStabilityPool",
        baseState.starInStabilityPool,
        baseStateUpdate.starInStabilityPool
      ),
      ...
      vePREONStaked: this._updateIfChanged(
        equals,
        "farm",
        baseState.vePREONStaked,
        baseStateUpdate.vePREONStaked
      ),
      remainingStabilityPoolPREONReward: this._silentlyUpdateIfChanged(
        eq,
        baseState.remainingStabilityPoolPREONReward,
        baseStateUpdate.remainingStabilityPoolPREONReward
      ),
      ...
      PREONPrice: this._updateIfChanged(
        eq,
        "PREONPrice",
        baseState.PREONPrice,
        baseStateUpdate.PREONPrice
      ),
      STARPrice: this._updateIfChanged(
        eq,
        "STARPrice",
        baseState.STARPrice,
        baseStateUpdate.STARPrice
      ),
