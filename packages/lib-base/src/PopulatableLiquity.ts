 ...
 * {@link @liquity/lib-base#STAR_MINIMUM_DEBT | minimum debt} requirement that Troves must fulfill,
 * some STAR amounts are not possible to redeem exactly.
 *
 * When {@link @liquity/lib-base#PopulatableLiquity.redeemSTAR | redeemSTAR()} is called with an
 * amount that can't be fully redeemed, the amount will be truncated (see the `redeemableSTARAmount`
 ...
 * {@link @liquity/lib-base#STAR_MINIMUM_NET_DEBT}.
 *
 * @public
 */
export interface PopulatedRedemption<P = unknown, S = unknown, R = unknown>
  ...
  /** Whether `redeemableSTARAmount` is less than `attemptedSTARAmount`. */
...
export interface PopulatableLiquity<R = unknown, S = unknown, P = unknown>
  ...
  /** {@inheritDoc TransactableLiquity.borrowSTAR} */
  borrowSTAR(
    amount: Decimalish,
    maxBorrowingRate?: Decimalish
  ): Promise<
  ...
  /** {@inheritDoc TransactableLiquity.repaySTAR} */
  repaySTAR(
    amount: Decimalish
  ): Promise<
    PopulatedLiquityTransaction<
  ...
  /** {@inheritDoc TransactableLiquity.depositSTARInStabilityPool} */
  ...
  /** {@inheritDoc TransactableLiquity.withdrawSTARFromStabilityPool} */
  ...
  /** {@inheritDoc TransactableLiquity.sendSTAR} */
  sendSTAR(
    toAddress: string,
    amount: Decimalish
  ): Promise<PopulatedLiquityTransaction<P, SentLiquityTransaction<S, LiquityReceipt<R, void>>>>;
  ...
  /** {@inheritDoc TransactableLiquity.redeemSTAR} */
  redeemSTAR(
    amount: Decimalish,
    maxRedemptionRate?: Decimalish
  ): Promise<PopulatedRedemption<P, S, R>>;
