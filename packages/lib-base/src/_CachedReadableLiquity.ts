...
import { vePREONStake } from "./vePREONStake";
...
export class _CachedReadableLiquity<T extends unknown[]>
  ...
  async getVEPREONStake(address: any, ...extraParams: any): Promise<any> {
    let _a;
    // console.log(address);
    return (_a = this._cache.getVEPREONStake(address, ...extraParams)) !== null && _a !== void 0
      ? _a
      : this._readable.getVEPREONStake(address, ...extraParams);
  }
  ...
  async getRemainingStabilityPoolPREONReward(...extraParams: any): Promise<any> {
    let _a;
    return (_a = this._cache.getRemainingStabilityPoolPREONReward(...extraParams)) !== null &&
      _a !== void 0
      ? _a
      : this._readable.getRemainingStabilityPoolPREONReward(...extraParams);
  }
  ...
  async getEstimatedVePreonRewards(amount: any, time: any, ...extraParams: any): Promise<any> {
    let _a;
    return (_a = this._cache.getEstimatedVePreonRewards(amount, time, ...extraParams)) !== null &&
      _a !== void 0
      ? _a
      : this._readable.getEstimatedVePreonRewards(amount, time, ...extraParams);
  }
  async getEstimatedPREONPoolRewards(amount: any, time: any, ...extraParams: any): Promise<any> {
    let _a;
    return (_a = this._cache.getEstimatedPREONPoolRewards(amount, time, ...extraParams)) !== null &&
      _a !== void 0
      ? _a
      : this._readable.getEstimatedPREONPoolRewards(amount, time, ...extraParams);
  }
  ...
  async getPREONBalance(address: any, ...extraParams: any): Promise<any> {
    let _a;
    return (_a = this._cache.getPREONBalance(address, ...extraParams)) !== null && _a !== void 0
      ? _a
      : this._readable.getPREONBalance(address, ...extraParams);
  }
  ...
  async getStarAllowance(from: any, to: any, amount: any, ...extraParams: any): Promise<any> {
    let _a;
    return (_a = this._cache.getStarAllowance(from, to, amount, ...extraParams)) !== null &&
      _a !== void 0
      ? _a
      : this._readable.getStarAllowance(from, to, amount, ...extraParams);
  }
  async getPREONPrice(...extraParams: any): Promise<any> {
    let _a;
    return (_a = this._cache.getPREONPrice(...extraParams)) !== null && _a !== void 0
      ? _a
      : this._readable.getPREONPrice(...extraParams);
  }
  async getSTARPrice(...extraParams: any): Promise<any> {
    let _a;
    return (_a = this._cache.getSTARPrice(...extraParams)) !== null && _a !== void 0
      ? _a
      : this._readable.getSTARPrice(...extraParams);
  }
  ...
  async getSTARInStabilityPool(...extraParams: T): Promise<Decimal> {
    return (
      this._cache.getSTARInStabilityPool(...extraParams) ??
      this._readable.getSTARInStabilityPool(...extraParams)
    );
  }

  async getSTARBalance(address?: string, ...extraParams: T): Promise<Decimal> {
    return (
      this._cache.getSTARBalance(address, ...extraParams) ??
      this._readable.getSTARBalance(address, ...extraParams)
    );
  }
