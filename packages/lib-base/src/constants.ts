 ...
 * @public
 */
export const STAR_LIQUIDATION_RESERVE = Decimal.from(200);

/**
 * A Trove must always have at least this much debt on top of the
 * {@link STAR_LIQUIDATION_RESERVE | liquidation reserve}.
 *
 * @remarks
 ...
 * @public
 */
export const STAR_MINIMUM_NET_DEBT = Decimal.from(1800);
 ...
 * @public
 */
export const STAR_MINIMUM_DEBT = STAR_LIQUIDATION_RESERVE.add(STAR_MINIMUM_NET_DEBT);
