...
export class PopulatableEthersLiquity implements PopulatableLiquity<EthersTransactionReceipt, EthersTransactionResponse, EthersPopulatedTransaction> {
    ...
    // (undocumented)
    attachment(tokenId: any, overrides: any): Promise<any>;
    // (undocumented)
    borrowSTAR(amount: any, ICRWithFees: any, maxBorrowingRate: any, overrides: any): any;
    // (undocumented)
    checkTokens(userAddress: any, overrides: any): Promise<any>;
    // (undocumented)
    claimable(tokenIds: any, token: any, overrides: any): Promise<any>;
    // (undocumented)
    claimCollateralSurplus(overrides: any): Promise<any>;
    // (undocumented)
    claimFees(overrides: any): Promise<any>;
    // (undocumented)
    claimMany(tokenIds: any, token: any, overrides: any): Promise<any>;
    // (undocumented)
    claimReward(tokenId: any, token: any, overrides: any): Promise<any>;
    // (undocumented)
    ...
    // (undocumented)
    getLockEnded(tokenId: any, overrides: any): Promise<any>;
    // (undocumented)
    ...
    // (undocumented)
    merge(from: any, to: any, overrides: any): Promise<any>;
    // (undocumented)
    ...
    // (undocumented)
    sendSTAR(toAddress: any, amount: any, overrides: any): Promise<any>;
    // @internal (undocumented)
    setPrice(price: any, overrides: any): Promise<any>;
    // (undocumented)
    stakeLPTokens(amount: any, tokenId: any, overrides: any): Promise<any>;
    // (undocumented)
    ...
    // (undocumented)
    withdrawSTARFromStabilityPool(amount: any, overrides: any): Promise<any>;
    // (undocumented)
...
export class PopulatedEthersRedemption extends PopulatedEthersLiquityTransaction<RedemptionDetails> implements PopulatedRedemption<EthersPopulatedTransaction, EthersTransactionResponse, EthersTransactionReceipt> {
    // @internal
    constructor(rawPopulatedTransaction: EthersPopulatedTransaction, connection: EthersLiquityConnection, attemptedSTARAmount: Decimal, redeemableSTARAmount: Decimal, increaseAmountByMinimumNetDebt?: () => Promise<PopulatedEthersRedemption>);
    // (undocumented)
...
export class ReadableEthersLiquity implements ReadableLiquity {
    ...
    // (undocumented)
    getEstimatedVePreonRewards(amount: any, time: any, overrides?: any): Promise<any>;
    // (undocumented)
    ...
    // (undocumented)
    getRemainingStabilityPoolPREONReward(overrides?: any): Promise<any>;
    // (undocumented)
