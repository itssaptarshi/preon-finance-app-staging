...
const tokenData: TokenData[] = [
  ...
  // ? yield bearing collaterals - dysonVaults
  {
    address: contractAddresses.stMaticVault.address, // update it by stMaticVault
    troveBalance: 0,
    walletBalance: 0,
    token: "stMATIC",
    isStable: false,
    isVault: true,
    underlying: "0x3A58a54C066FdC0f2D55FC9C89F0415C92eBf3C4", // set underlying token
    underlyingDecimals: 18,
    tokenTooltip: "",
    feeTooltip: ""
  },
  {
    address: contractAddresses.usdPlusVault.address, // update it by usdPlusVault
    troveBalance: 0,
    walletBalance: 0,
    token: "USDPlus",
    isStable: false,
    isVault: true,
    underlying: "0x236eeC6359fb44CCe8f97E99387aa7F8cd5cdE1f", // set underlying token
  ...
  // ========== MESH STRATEGY ============
  {
    address: contractAddresses.iWmaticVault.address, // update it by usdPlusVault
    troveBalance: 0,
    walletBalance: 0,
    token: "iWMATIC",
    isStable: false,
    isVault: true,
    underlying: "0xb880e6AdE8709969B9FD2501820e052581aC29Cf", // set underlying token
    underlyingDecimals: 18,
    tokenTooltip: "",
    feeTooltip: ""
  },
  {
    address: contractAddresses.iUsdcVault.address, // update it by usdPlusVault
    troveBalance: 0,
    walletBalance: 0,
    token: "iUSDC",
    isStable: false,
    isVault: true,
    underlying: "0x590Cd248e16466F747e74D4cfa6C48f597059704", // set underlying token
    underlyingDecimals: 6,
    tokenTooltip: "",
    feeTooltip: ""
  },
  {
    address: contractAddresses.iDaiVault.address, // update it by usdPlusVault
    troveBalance: 0,
    walletBalance: 0,
    token: "iDAI",
    isStable: false,
    isVault: true,
    underlying: "0xbE068B517e869f59778B3a8303DF2B8c13E05d06", // set underlying token
    underlyingDecimals: 18,
    tokenTooltip: "",
    feeTooltip: ""
  }

  // 0xbE068B517e869f59778B3a8303DF2B8c13E05d06 = idai
