      ...
      {showIcons && (
        <Flex mr={1.5} direction="column">
          ...
          >
            <Text
              textStyle="subtitle3"
              bg={iconStatus[token] === "deposit" ? "" : "transparent"}
              color={iconStatus[token] === "deposit" ? "white" : "whiteAlpha.600"}
              borderWidth="1px"
              borderStyle="solid"
              borderColor={iconStatus[token] === "deposit" ? "purple" : "purple"}
              borderRadius="full"
              cursor="pointer"
              align="center"
              px={2}
          ...
          >
            <Text
              textStyle="subtitle3"
              bg={iconStatus[token] === "withdraw" ? "" : "transparent"}
              color={iconStatus[token] === "withdraw" ? "white" : "whiteAlpha.600"}
              borderWidth="1px"
              borderStyle="solid"
              borderColor={iconStatus[token] === "withdraw" ? "purple" : "purple"}
              borderRadius="full"
              cursor="pointer"
              align="center"
              px={2}
